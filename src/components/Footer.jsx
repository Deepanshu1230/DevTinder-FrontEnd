...
const Footer = () => {
  return (
      ...
      <nav className="flex justify-center space-x-6 text-lg font-semibold mb-4">
        ...
        <a className="hover:text-white transition duration-300 cursor-pointer">Contact</a>
        <a className="hover:text-white transition duration-300 cursor-pointer">Jobs</a>
        <a className="hover:text-white transition duration-300 cursor-pointer">Press Kit</a>
      </nav>
